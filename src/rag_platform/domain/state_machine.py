...
_ALLOWED: dict[DocumentStatus, set[DocumentStatus]] = {
    ...
    # ACTIVE -> EMBEDDING permits explicit re-indexing after model/config changes.
    DocumentStatus.ACTIVE: {DocumentStatus.EMBEDDING, DocumentStatus.DELETING},
    DocumentStatus.FAILED_DOWNLOAD: {DocumentStatus.DELETING},
    DocumentStatus.FAILED_PARSE: {DocumentStatus.DELETING},
    DocumentStatus.FAILED_EMBEDDING: {DocumentStatus.EMBEDDING, DocumentStatus.DELETING},
    DocumentStatus.FAILED_INDEXING: {DocumentStatus.EMBEDDING, DocumentStatus.DELETING},
