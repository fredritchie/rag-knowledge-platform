...
export async function POST(request: NextRequest) {
  ...
  // Tenant IDs include generated IDs and seeded IDs such as `ten_demo_a`.
  if (!/^ten_[a-zA-Z0-9_]+$/.test(tenantId)) return NextResponse.json({ code: "INVALID_TENANT" }, { status: 400 });
