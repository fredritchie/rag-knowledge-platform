...
output "duckdns_ipv4" { value = module.platform.duckdns_ipv4 }
output "global_accelerator_ipv4_addresses" { value = module.platform.global_accelerator_ipv4_addresses }
